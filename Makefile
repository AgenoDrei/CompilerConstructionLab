...
cc1ab: y.tab.c lex.yy.c
		$(CC) -g y.tab.c lex.yy.c StringNode.cpp ApplyNode.cpp ReturnNode.cpp GroundNode.cpp UpdateNode.cpp IndependenceNode.cpp CopyNode.cpp EntryNode.cpp SubProblem.cpp BaseNode.cpp Problem.cpp BaseProblem.cpp -lfl -lm -o cc1ab
